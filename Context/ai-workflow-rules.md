...
- UI changes, backend REST API's, database changes
...
- SurfTracker\src\components — generated UI library components
- Any third-party library internals

These should reman default and reusable.

Project-specific styling, layour changes, and feature logic must be implemented in app-level components instead of modifying foundation components.
...
Project state must reflect the actual state of the implementation, not the intended state.
